<?php
	...
	$CC="g++";
	$out="timeout 2s ../submittedfile/".$userDir."/./".$userId;
	$code=$_POST["value"];
	$filename_code="../submittedfile/".$userDir."/".$userId."_".$_SESSION['questionNo'].".cpp";
	$filename_error="../submittedfile/".$userDir."/".$userId."error.txt";
	$executable="../submittedfile/".$userDir."/".$userId;
	$command=$CC." ".$filename_code." -o ../submittedfile/".$userDir."/".$userId;
	...
	exec("rm ../submittedfile/".$userDir."/".$userId.".o");
